                                ...
                                ext:(NSString *)aExt
{
    ...
    ConferenceViewController *confController = [[ConferenceViewController alloc] initWithCallId:aConfId creater:creater otherUsers:others type:type conversationId:nil];
