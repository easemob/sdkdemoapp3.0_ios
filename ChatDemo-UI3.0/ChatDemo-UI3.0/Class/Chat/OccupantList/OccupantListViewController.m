...
- (EMSearchDisplayController *)searchController
{
    if (_searchController == nil) {
        ...
        [_searchController setDidSelectRowAtIndexPathCompletion:^(UITableView *tableView, NSIndexPath *indexPath) {
            ...
            if ([selectOccupant isEqualToString:[[EaseMob sharedInstance].chatManager loginInfo][kSDKUsername]])
            {
                //如果选中的为用户本人
...
- (void)reloadDataSource
{
    ...
    [[EaseMob sharedInstance].chatManager asyncFetchGroupInfo:self.chatGroup.groupId
                                         includesOccupantList:YES
