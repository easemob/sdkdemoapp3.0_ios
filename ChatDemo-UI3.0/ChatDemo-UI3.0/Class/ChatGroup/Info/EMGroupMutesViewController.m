                 ...
                 isHeader:(BOOL)aIsHeader
{
    ...
    [[EMClient sharedClient].groupManager fetchGroupMuteList:self.group.groupId pageNumber:self.page pageSize:pageSize completion:^(NSArray *aMembers, EMError *aError) {
        [weakSelf hideHud];
