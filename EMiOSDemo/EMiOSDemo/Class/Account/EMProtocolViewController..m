...
- (WKWebView *)webView
{
    ...
    _webView = [[WKWebView alloc]initWithFrame: CGRectMake(0, 44 + StatusBarAndNavigationBarHeight, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height) configuration:config];
...
- (void)setupNavigationItem{
    ...
    [backButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view).offset(44 + StatusBarHeight);
...
- (UIProgressView *)progressView {
    if (!_progressView){
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, StatusBarAndNavigationBarHeight + 46, self.view.frame.size.width, 2)];
